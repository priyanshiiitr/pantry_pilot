...
def test_groq_without_api_key_raises_a_helpful_error(monkeypatch: pytest.MonkeyPatch) -> None:
    """A missing GROQ_API_KEY should fail loudly and clearly, not with a confusing network error."""
